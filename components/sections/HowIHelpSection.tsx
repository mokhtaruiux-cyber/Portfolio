...
import { masterTitleReveal, sectionPacing, stagger, viewportDefaults } from '../../lib/motionTokens';
  ...
  return (
    <Section id="help" eyebrow={howIHelp.eyebrow}>
      <div className="text-left mb-10">
        <SectionTitle
          title={howIHelp.titleLines[0] ?? ''}
          highlight={howIHelp.titleLines[1] ?? ''}
          delay={pacing.title}
          stackHighlight
      ...
      <motion.div
        ...
        variants={stagger.container(0.04, 0.05)}
        initial="initial"
        whileInView="animate"
