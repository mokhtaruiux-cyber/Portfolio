                ...
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "relative h-9 px-4 sm:px-5 rounded-full transition-all duration-300 whitespace-nowrap z-10",
                                typography.labelXs,
                                isActive
                                    ? "text-white"
                                    : cn("opacity-60 hover:opacity-100", darkMode ? "text-white" : "text-black")
                            )}
                        >
                            {isActive && (
                                <motion.div
                                    layoutId="activeTab"
                                    className="absolute inset-0 rounded-full border bg-[#2f6bff]/20 border-[#2f6bff]/30 -z-10"
